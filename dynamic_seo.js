    ...
    * - <link rel="canonical">
    ...
    const bannerUrl = homePageUrl+"images/full_logo.png";
        ...
        const metaData = {
            home: {
                title: "CodeStudyZone | Learn Coding Online",
                description:
            ...
            java: {
                title: "Learn Java Programming | CodeStudyZone",
                description:
            ...
            python: {
                title: "Learn Python | CodeStudyZone",
                description:
            ...
            blog: {
                title: "CodeLearnHub Blog — Programming Tips, Tutorials & Tech Insights",
                description:
                    "Simple and practical Python tutorials for beginners. Learn syntax, loops, functions, and more.",
            ...
            cpp: {
                title: "Learn C++ Programming — Beginner to Advanced | CodeLearnHub",
                description:
                    "Master C++ programming with step-by-step tutorials from CodeLearnHub. Learn syntax, OOP concepts, STL, and best practices for writing efficient C++ code.",
                url: homePageUrl + "cpp/",
                image: bannerUrl,
                schemaType: "TechArticle",
                schemaData: {
            ...
            csharp: {
                title: "Learn C# Programming — Step-by-Step Guide | CodeLearnHub",
                description:
                    "Learn C# programming with CodeLearnHub’s easy-to-follow tutorials. Explore .NET, OOP, LINQ, and modern C# coding practices for beginners and professionals.",
            ...
            kotlin: {
                title: "Learn Kotlin Programming — Android & JVM Development | CodeLearnHub",
                description:
                    "Learn Kotlin programming from scratch with CodeLearnHub. Master syntax, OOP, coroutines, and Android app development using Kotlin.",
